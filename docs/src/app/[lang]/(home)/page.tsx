...
const messages = {
  en: {
    eyebrow: 'MGCanvas AI canvas workspace',
    center: 'Documentation',
    description: 'Learn how to run MGCanvas, organize node-based creative workflows, manage local assets, and connect your own model services.',
    quickStart: 'Quick Start',
    gallery: 'Gallery',
    features: 'Explore Features',
    previewAlt: 'MGCanvas preview',
  },
  'zh-CN': {
    eyebrow: 'MGCanvas AI 画布工作空间',
    center: '文档中心',
    description: '了解如何启动 MGCanvas、组织节点式创作流程、管理本地素材，并连接你自己的模型服务。',
    quickStart: '快速开始',
    gallery: '效果展示',
    features: '功能介绍',
    previewAlt: 'MGCanvas 效果图',
  },
};
