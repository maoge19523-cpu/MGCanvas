...
export const useAgentStore = create<AgentStore>((set, get) => ({
    width: typeof window === "undefined" ? 440 : Number(localStorage.getItem("mgcanvas:agent-panel-width")) || 440,
    panelOpen: false,
    panelMounted: true,
    panelClosing: false,
    canvasContext: null,
    url: typeof window === "undefined" ? "http://127.0.0.1:17371" : localStorage.getItem("mgcanvas:agent-url") || "http://127.0.0.1:17371",
    token: typeof window === "undefined" ? "" : localStorage.getItem("mgcanvas:agent-token") || "",
    connected: false,
    enabled: false,
    silentConnect: false,
    prompt: "",
    ...
    activeTab: "setup",
    confirmTools: false,
    permissionMode: typeof window === "undefined" ? "request" : (localStorage.getItem("mgcanvas:agent-permission-mode") as AgentPermissionMode) || "request",
    models: [],
    model: typeof window === "undefined" ? "" : localStorage.getItem("mgcanvas:agent-model") || "",
    reasoningEffort: typeof window === "undefined" ? "" : (localStorage.getItem("mgcanvas:agent-reasoning-effort") as AgentReasoningEffort) || "",
    ...
    connectAgent: (options) => {
        ...
        localStorage.setItem("mgcanvas:agent-url", endpoint);
        localStorage.setItem("mgcanvas:agent-token", token);
