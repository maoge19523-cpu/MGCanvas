 ...
 * 图片模型（CogView 系列与 glm-image）不在 OpenAI 兼容的 /models 列表里，需要手动填模型名，
 * 且请求体格式与 OpenAI 不同，因此用调用脚本转换。
 */
const ZHIPU_IMAGE_SCRIPT = [
    // 面板传的是具体尺寸（如 720x1280），映射到接口支持的画幅尺寸。
    // 两代模型的尺寸要求不同：glm-image 要求长宽都能被 32 整除（实测 1440x720 会被拒回 1214），
    // 所以按模型分别使用各自官方推荐的枚举值；匹配不上则不传，交给接口默认值。
    'const GLM_IMAGE_SIZES = { "1024x1024": "1280x1280", "1:1": "1280x1280", "1280x720": "1728x960", "16:9": "1728x960", "720x1280": "960x1728", "9:16": "960x1728", "1152x864": "1472x1088", "4:3": "1472x1088", "864x1152": "1088x1472", "3:4": "1088x1472" };',
    'const COGVIEW_SIZES = { "1024x1024": "1024x1024", "1:1": "1024x1024", "1280x720": "1440x720", "16:9": "1440x720", "720x1280": "720x1440", "9:16": "720x1440", "1152x864": "1152x864", "4:3": "1152x864", "864x1152": "864x1152", "3:4": "864x1152" };',
    'const SIZE_MAP = /^glm-image/i.test(String(model || "")) ? GLM_IMAGE_SIZES : COGVIEW_SIZES;',
    'const rawSize = params.size ? String(params.size).trim() : "";',
