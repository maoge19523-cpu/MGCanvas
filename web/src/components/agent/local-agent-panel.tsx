...
type AgentClientGlobal = typeof globalThis & { __mgcanvasAgentClientIdPromise?: Promise<string> };
...
function acquireAgentClientId() {
    ...
    scope.__mgcanvasAgentClientIdPromise ||= (async () => {
        ...
        while (true) {
            const acquired = await new Promise<boolean>((resolve, reject) => {
                void navigator.locks.request(`mgcanvas-agent:${clientId}`, { ifAvailable: true }, async (lock) => {
    ...
    return scope.__mgcanvasAgentClientIdPromise;
}
