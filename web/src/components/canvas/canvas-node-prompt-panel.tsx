    ...
    return (
        ...
        >
            {mentionReferences.some((reference) => reference.active && reference.nodeId !== node.id) ? (
                <CanvasResizableArea storageKey={`mgcanvas:node-reference-height:${node.id}`} defaultHeight={84} minHeight={72} maxHeight={220} resizeLabel={t("canvas.references.resizePreview")} className="mb-2.5">
            ...
            <CanvasResizableArea storageKey={`mgcanvas:node-prompt-height:${node.id}`} defaultHeight={160} minHeight={96} maxHeight={420} resizeLabel={t("canvas.promptPanel.resizeInput")}>
